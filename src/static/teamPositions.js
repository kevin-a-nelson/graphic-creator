...
export default {
    ...
    "SinglePool": {
        ...
        text: [
            ...
            { top: `${45.8}%`, left: '23%', name: '1st', style: singlePool.teamRecord, isConstant: true },
            { top: `${45.8}%`, left: '32%', name: '0 - 0', style: singlePool.teamRecord },
            { top: '43.5%', left: '40.5%', name: 'Team Name 1', style: singlePool.teamName },
            { top: `${57.5}%`, left: '23%', name: '2nd', style: singlePool.teamRecord, isConstant: true },
            { top: `${57.5}%`, left: '32%', name: '0 - 0', style: singlePool.teamRecord },
            { top: `${55}%`, left: '40.5%', name: 'Team Name 2', style: singlePool.teamName },
            { top: `${68.5}%`, left: '23%', name: '3rd', style: singlePool.teamRecord, isConstant: true },
            { top: `${68.5}%`, left: '32%', name: '0 - 0', style: singlePool.teamRecord },
            { top: `${66.3}%`, left: '40.5%', name: 'Team Name 3', style: singlePool.teamName },
            { top: `${80.5}%`, left: '23%', name: '4th', style: singlePool.teamRecord, isConstant: true },
            { top: `${80.5}%`, left: '32%', name: '0 - 0', style: singlePool.teamRecord },
